...
#include <string.h>
#include <stdbool.h>
//VERIFICA SE ALGUÉM GANHOU O JOGO, DEPOIS DISSO ENVIA PARA A MAIN A RESPOSTA.
...
//IMPRIME O JOGO DA VELHA, E SEU ESTADO CONFORME SÃO FEITAS AS JOGADAS
...
//CHAMA AS FUNÇÕES AUXILIARES, EXECUTA O JOGO, AVISA EMPATE OU O VENCEDOR
int main()
{
